...
angular.module('app', [])
 ...
 $scope.comment = function() {
      ...
      api.comment($scope.parentAuthor, $scope.parentPermlink, $scope.user.name, permlink, 'new title', 'hai',{ tags: ['test'], app: `steemjs/examples` }, // Json Metadata, function(err, result) {
